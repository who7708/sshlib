...
public class Connection implements AutoCloseable {
    ...
    private final Vector<ConnectionMonitor> connectionMonitors = new Vector<ConnectionMonitor>();
     ...
     *
     * @param user           A <code>String</code> holding the username.
     * @param signatureProxy A <code>SignatureProxy</code> containing a public key and implementing
     *                       a sign method.
     * @return Whether the connection is now authenticated.
     ...
     * Unless you know what you are doing, you will never need this.
     *
     * @param algos An array of allowed key exchange algorithms.
     */
